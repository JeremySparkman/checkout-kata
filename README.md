# Checkout Order Total Kata Setup Instructions

1. Install Node.js (I'm using v10.15.3).
2. Install npm (v6.4.1).
3. From the root folder of the project run, "npm install".
4. To run the tests, "npm run test".

# Checkout Order Total Kata Description and Requirements
